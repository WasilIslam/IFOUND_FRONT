...
const FounDetails = ({route,navigation}) => {
    ...
    const handleNext=()=>{
        ...
        if(name=="" || age=="" || location==""){
            ...
            navigation.navigate("FoundPhotos",{data:{name,age,gender,location}})
        }
    }
    return (
        <ScrollView>
            <View style={styles.main}>
                <View style={styles.headingSection}>
                    <Logo title='Found form' />
                    <Text style={[textStyles.simple, { marginTop: 7 }]}>Found Someone? Report here
                        <Ionicon name='arrow-down' size={16} />
                    </Text>
                </View>
                <View style={styles.form}>
                    <FormElement text={"Founding Location"} element={<FormInput value={location} onInput={setLocation} />} />
